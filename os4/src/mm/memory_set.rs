...
use spin::Mutex;
use crate::mm::heap_allocator::HEAP_SPACE;
...
impl MemorySet {
    ...
    pub fn new_kernel() -> Self {
        info!("[Kernel] Mapping the kernel space");
    ...
    pub fn activate(&self) {
        ...
        info!("After activating, the address of ppn root written to satp is {satp:#x}");
    }
